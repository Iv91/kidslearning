                    ...
                    <div className="container-fluid">
                        <div className="row align-items-center w-100" style={{ margin: 0 }}>
                            ...
                            <div className="col-md-6 d-none d-md-flex justify-content-center p-0">
                                <ul className="navbar-nav kl-nav-links d-flex flex-row m-0 p-0">
                                    <li className="nav-item">
                                        <a className="nav-link" href={`http://localhost:8000/?lang=${ lang }`}>
                                            {t.home}
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" href={`http://localhost:8000/about/?lang=${ lang }`}>
                                            {t.about}
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" href={`http://localhost:8000/lessons/?lang=${ lang }`}>
                                            {t.lessons}
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link" href={`http://localhost:8000/resources/?lang=${ lang }`}>
                                            {t.resources}
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" href={`http://localhost:8000/contact/?lang=${ lang }`}>
                                            {t.contact}
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div className="col-6 col-md-3 d-flex justify-content-end align-items-center kl-right p-0">
                                {/* Search */}
                                {!showSearch ? (
                                    <button type="button" className="kl-icon-btn" onClick={() => setShowSearch(true)}>
                                        🔍
                                    </button>
                                ) : (
                                    <form
                                        method="get"
                                        action="http://localhost:8000/lessons/search/"
